        ...
        <div>
          <div className="flex items-center justify-between flex-wrap gap-24p pb-30p border-b border-shap">
            ...
            <div className="flex items-center max-sm:justify-center overflow-x-auto scrollbar-0 max-w-[680px] ">
              ...
              <div className="flex flex-wrap gap-2 text-base text-w-neutral-1 *:rounded-12 *:px-20p *:py-3 whitespace-nowrap">
          ...
          <div className="grid 3xl:grid-cols-5 xl:grid-cols-4 md:grid-cols-5 grid-cols-4 gap-2 mt-10p">
            {filteredhero?.map((item, idx) => (
              <div
                key={idx}
                className="relative bg-b-neutral-3 rounded-12 group overflow-hidden w-full h-full "
              >
                <Link
                    href={`/gameinfo/heroes/${item?.key}`}
                    className="xl:heading-6 link-1 mb-2 line-clamp-1"
                  >
                <div className="overflow-hidden">
                  {/* <span className="badge badge-neutral absolute top-3 left-3 z-[2]">
                    <span className="avatar avatar-primary size-1"></span>
...
export default HeroDetailsAside;
