        ...
        <div key={idx}>
          ...
          <div>
            ...
            <div className="flex items-center flex-wrap gap-3 md:gap-[18px] mb-20p">
              ...
              <p className="text-sm text-w-neutral-4">
                Liked{" "}
                <Link href={"/profile"} className="span text-w-neutral-1">
                  {item?.likes[0].name}
                </Link>{" "}
            ...
            <div>
              <div className="pt-20p border-t border-shap">
                ...
                <AnimateHeight
                  duration={500}
                  height={showMoreComments === item?.id ? "auto" : 0}
                >
                ...
                <div className="mt-20p">
                  <button
                    onClick={() =>
                      setShowMoreComments((prevId) =>
                        prevId === item?.id ? null : item?.id
                      )
                    }
                    type="button"
                    className="text-m-medium text-w-neutral-1 mb-16p block"
                  >
                    View 02 more comment
                  </button>
                  <form className="flex items-center justify-between gap-24p bg-b-neutral-2  rounded-full py-16p px-32p">
                    <input
                      className="w-full bg-transparent text-base text-white placeholder:text-w-neutral-1"
                      type="text"
                      name="name"
