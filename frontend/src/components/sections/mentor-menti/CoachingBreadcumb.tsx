...
const CoachingBreadcrumb = ({ breadcrumb }: { breadcrumb: BreadcrumbType }) => {
  return (
    <section className={twMerge("pt-30p", breadcrumb?.className)}>
      <div className="section-pt">
        <div className="relative bg-[url('/images/media_poster/2600_S17_Overview.jpg')] bg-cover bg-no-repeat rounded-24 overflow-hidden">
...
export default CoachingBreadcrumb;
