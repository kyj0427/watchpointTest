...
const featuredVideosData = [
  {
    ...
    title: "겐지 - 사이버 닌자 마스터",
    description: "겐지의 모든 스킬과 콤보를 완벽하게 마스터하는 방법을 배워보세요.",
  ...
  },
  {
    ...
    title: "메르시 - 천사의 힐링",
    description: "메르시로 팀을 완벽하게 지원하는 방법과 포지셔닝 팁을 공유합니다.",
  ...
  },
  {
    ...
    title: "라인하르트 - 방패의 기사",
    description: "라인하르트의 방어와 공격 타이밍을 완벽하게 조절하는 방법을 배워보세요.",
  ...
  },
  {
    ...
    title: "모이라 - 생명의 과학자",
    description: "모이라의 힐링과 데미지를 균형있게 조절하는 고급 플레이 전략을 공유합니다.",
