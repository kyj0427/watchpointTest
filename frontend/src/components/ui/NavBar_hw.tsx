              ...
              <nav className="relative xl:grid xl:grid-cols-12 flex justify-between items-center gap-24p text-semibold w-full">
                ...
                <div className="3xl:col-span-6 xl:col-span-7 flex items-center xl:justify-between justify-end w-full">
                 <div className="relative" ref={notifRef}>
                    <button
                      onClick={toggleNotif}
                      className="inline-flex items-center gap-3 pl-1 py-1 pr-6 rounded-full bg-[rgba(242,150,32,0.10)] text-w-neutral-1 text-base"
                    >
                      ...
                      {isNotifOpen && (
                    <div className="absolute top-full right-0 mt-3 w-80 bg-white text-gray-800 rounded-xl shadow-2xl z-50 p-4 ring-1 ring-gray-200">
                     <h4 className="text-base font-bold mb-3 flex items-center gap-2 text-gray-900 border-b pb-2 border-gray-200">
                        <span className="text-yellow-500"><IconBell size={20} /></span>
                        Alerts
                       </h4>
                      <ul className="flex flex-col gap-2 text-sm">
                        ...
                        >
                          <span className="text-purple-600"><IconMessages size={18} /></span>
                          A new comment has been posted!
                        </li>
                        <li
                          onClick={() => {
                            router.push('/faq-details');
                            toggleNotif();
                          }}
                          className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-100 transition cursor-pointer"
                        >
                          <span className="text-red-500"><IconMail size={18} /></span>
                          You have a reply to your inquiry!
                        </li>
                        <li
                          onClick={() => {
                            router.push('/groups');
                          ...
                          className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-100 transition cursor-pointer"
                        >
                          <span className="text-indigo-600"><IconUsersGroup size={18} /></span>
                          Your squad match is ready!
                        </li>
                      </ul>
                    </div>
                  )}
